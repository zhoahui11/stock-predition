...
plt.plot( np.arange(len(y_test_true)), y_test_true, label='Test True',color='#EC1A23')##EC1A23
# plt.plot(len(y_train_true) + np.arange(len(y_test_true)), y_test_pred, label='Test Predicted',color='darkviolet')
plt.plot( np.arange(len(y_test_true)), y_test_pred, label='Test Predicted',color='#5B8F9B')#deepskyblue royalblue  green#5BB847
plt.legend()
